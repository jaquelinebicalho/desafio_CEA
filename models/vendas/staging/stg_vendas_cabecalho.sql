with 
    renomeado as (
        select
            ...
            ,cast (SUBTOTAL as number(18,2)) as cabecalho_venda_valor_subtotal
            ...
            --,cast (ONLINEORDERFLAG as varchar) as cabecalho_venda_online   -- 0 se for colocado por vendedor  1 se entrou online pelo cliente  
            ,case 
            ...
            --,cast (COMMENT as varchar) as cabecalho_venda_observacoes
