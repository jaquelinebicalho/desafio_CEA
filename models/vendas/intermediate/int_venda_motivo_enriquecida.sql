with 
    ...
    ,venda_motivo_enriquecida as (
        select 
            vendas_cabecalho.pk_id_ordem_de_venda  as  "Nota Fiscal"
            ,coalesce(venda_motivo.venda_motivo_nome, 'Não Informado') as "Motivo Venda"
            ,coalesce(venda_motivo.venda_motivo_tipo, 'Não Informado') as "Motivo Tipo"
